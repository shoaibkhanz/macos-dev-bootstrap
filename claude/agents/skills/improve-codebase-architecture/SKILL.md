...
Then walk the codebase — delegate to an explorer sub-task if your harness supports it, otherwise grep/read directly. Don't follow rigid heuristics — explore organically and note where you experience friction:
